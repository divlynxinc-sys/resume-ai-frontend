...
function CTABanner() {
  return (
    <div className="mx-auto max-w-3xl rounded-2xl bg-gradient-to-br from-indigo-700 to-blue-700 text-white p-8 md:p-10 shadow-[0_20px_60px_rgba(29,78,216,0.35)]">
      ...
      <p className="mt-3 text-center text-white/80 text-sm md:text-[15px]">Join thousands of professionals who have successfully advanced their careers with Jobsynk AI.</p>
  ...
  return (
    <footer className="mt-16 border-t border-white/10">
      <div className="mx-auto max-w-7xl px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-sm text-white/60">
        ...
        <div>© 2024 Jobsynk AI. All rights reserved.</div>
      </div>
    </footer>
  );
}
    ...
    <div className="min-h-screen bg-[var(--app-bg)] text-white">
      ...
      <main className="mx-auto max-w-7xl px-6">
        <section className="pt-10 text-center">
          <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight">What people say about Jobsynk AI</h1>
        ...
        <section className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          <TestimonialCard
            title="Jobsynk AI transformed my job search!"
            body="I was struggling to articulate my skills and experience effectively. Jobsynk AI's suggestions helped me create a resume that truly stands out. Within weeks, I received multiple interview invitations and landed a fantastic role in marketing."
            tone="from-orange-200 to-rose-200"
          />
          <TestimonialCard
            title="I landed my dream job thanks to Jobsynk AI."
            body="After countless rejections, I turned to Jobsynk AI. The platform's intuitive interface and expert guidance helped me craft a resume that perfectly highlighted my qualifications. I'm now working in a leading tech company, a position I wouldn't have secured without Jobsynk AI."
            tone="from-amber-200 to-pink-200"
          />
          <TestimonialCard
            title="Jobsynk AI is a game-changer!"
            body="I've tried other resume builders, but Jobsynk AI is in a league of its own. The AI-driven insights and customizable templates made the process incredibly easy. I highly recommend it to anyone looking to advance their career."
