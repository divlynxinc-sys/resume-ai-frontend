/**
 * Early-access offer: 40% off all plans, auto-applied at checkout (no code).
 *
 ...
 *
 * Deliberately NOT 50%-off-with-a-code: differentiates us from competitors
 * running coupon-code launch promos. Ours has no code and an honest end date.
 */
